...
# -*- coding: utf-8 -*-
"""
Remote Encoding Task Launcher  (ngrok Tunnel)
=============================================
Usage:  python run_remote.py
Requires ngrok.exe at C:\\Pictures-task\\ngrok.exe
Auth token is read from ..\\memory_test\\.ngrok_token (configured once with
...
def main():
    print()
    print('=== Encoding Task Remote Launcher (ngrok Tunnel) ===')
    print()
    ...
    print('Starting encoding task server (Flask) on port {}...'.format(PORT))
